...
class Task(models.Model):
    ...
    uploaded_by = models.ForeignKey(User,related_name="job_uploaded")
    worker = models.ManyToManyField(User, related_name="teamMate")
    created_at = models.DateTimeField(auto_now_add=True)
    updated_at = models.DateTimeField(auto_now=True)
    
    def __repr__(self):
        return f"User: {self.id} {self.description} {self.uploaded_by}"
